...
const FIELDS = ['Contact.Name', 'Contact.Phone', 'Contact.Birthdate', 'Contact.MailingStreet'];
...
export default class PdftronWvInstance extends LightningElement {
  ...
  handleBlobSelected(record) {
    ...
    this.iframeWindow.postMessage({ type: "OPEN_DOCUMENT_BLOB", payload }, window.origin);
  }
